...
/** UUID для демо; у проді підставте реальний location_id з таблиці locations */
...
export const mockOrders: OrderRow[] = [
  ...
  },
  {
    ...
    source: 'Доставка',
    customer_note: null,
    prep_started_at: new Date(Date.now() - 4 * 60_000).toISOString(),
    ready_at: null,
  ...
  },
  {
    ...
    source: 'Зал',
    customer_note: null,
    prep_started_at: new Date(Date.now() - 12 * 60_000).toISOString(),
